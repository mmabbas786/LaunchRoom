...
import { ArrowRight, CheckCircle2, ChevronRight, Globe, Layout, ShieldCheck, Zap } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Website Development for Startups & Businesses | LaunchRoom Studio",
  description:
    "LaunchRoom builds fast, modern, mobile-first websites for startups and growing businesses. High converting design, Next.js architecture, and SEO standard on every build.",
  keywords: [
    "website development",
