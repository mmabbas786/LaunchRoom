...
import { ArrowRight, CheckCircle2, Code, Cpu, Database, Layers, Lock, Zap } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Custom Web Application Development | SaaS & Portal Builds",
  description:
  ...
  alternates: {
    canonical: `${siteConfig.url}/web-app-development`,
  },
  openGraph: {
    title: "Custom Web Application Development | LaunchRoom",
    description:
